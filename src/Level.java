...
/*            
            Image2D explode = new Image2D(Image2D.RGBA,Image.createImage("/explosion2.gif")); 
            CompositingMode comp = new CompositingMode();comp.setBlending(CompositingMode.ALPHA);
            Appearance appr = new Appearance();appr.setCompositingMode(comp);
				Sprite3D sprt = new Sprite3D(true,explode,appr);
*/				            
